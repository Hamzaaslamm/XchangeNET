...
class AdminChatNotificationScreen extends StatefulWidget {
  const AdminChatNotificationScreen({super.key});

  @override
  _AdminChatNotificationScreenState createState() => _AdminChatNotificationScreenState();
}

class _AdminChatNotificationScreenState extends State<AdminChatNotificationScreen> {
  @override
  void initState() {
    inputData();
    super.initState();
