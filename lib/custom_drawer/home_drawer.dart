...
import '../src/view/screen/user/all_product_screen.dart';
import '../src/view/screen/login_screen.dart';
...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        ...
        // isAssetsImage: true,
        // imageName: 'assets/images/promotion.png',
      ),
      DrawerList(
      ...
      DrawerList(
        index: DrawerIndex.Block,
        labelName: 'Block User',
        icon: Icon(Icons.block),
      ),
      DrawerList(
        index: DrawerIndex.Suspend,
        labelName: 'Suspend User',
        icon: Icon(Icons.dangerous),
      ),
      // DrawerList(
      //   index: DrawerIndex.Complain,
      //   labelName: 'Complains',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppThemeAdmin.notWhite.withOpacity(0.5),
      body: Column(
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: <BoxShadow>[
                                BoxShadow(
                                    color: AppThemeAdmin.grey.withOpacity(0.6),
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: isLightMode ? AppThemeAdmin.grey : AppThemeAdmin.white,
                            fontSize: 18,
                          ),
                        ),
                        Text(
            ...
            children: <Widget>[
              ListTile(
                title: Text(
                  'Log Out',
                  style: TextStyle(
                    fontFamily: AppThemeAdmin.fontName,
                    fontWeight: FontWeight.w600,
                    fontSize: 16,
                    color: AppThemeAdmin.darkText,
                  ),
